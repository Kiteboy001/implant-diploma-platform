...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-dark px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300 mt-2">Join The Implant Diploma delegate portal</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-2xl p-8">
          <form action={action} className="space-y-5">
            <div>
              ...
              />
              {state?.errors?.name && (
                <p className="text-red-600 text-sm mt-1.5">{state.errors.name[0]}</p>
              )}
            </div>
          ...
          <p className="text-center text-sm text-gray-600 mt-6">
            ...
            <Link href="/auth/login" className="text-brand font-semibold hover:text-brand-light transition-colors">
              Sign in
            </Link>
          </p>
        </div>
